...
\section{Self Study}
  \resumeSubHeadingListStart
    \resumeSubItemSimple
      {AWS Developer - Building on AWS Harvard CS50 - Introduction to Computer Science Stanford CS106b - Programming Abstractions Stanford CS144 - Introduction to Computer Networking Stanford Lagunita - Introduction to Databases UC Berkeley CS162 - Operating Systems and Systems Programming UCSD Data Structures and Algorithms Specialization}
  \resumeSubHeadingListEnd
